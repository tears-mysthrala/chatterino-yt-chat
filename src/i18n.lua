...
local TEXT = {
  es = {
    help = "Comandos: <url> | list | status | health | pause <canal> | resume <canal> | " ..
        "remove <canal> | delay [ms] | language [es|en] | config | export | import",
    ...
    status_item = "{channel} · {splits} split(s) · cola {queued} · próximo sondeo {next} s{error}",
